...
def build_map_dict_by_name(gdpinfo, plot_countries, year):
    ...
    for plot_countries_code in plot_countries :
        for isp_country_code in gdpinfo :
            ...
            if gdpinfo[isp_country_code]["Country Name"] == plot_countries[plot_countries_code] : # 判断绘图库里的国家是否在世界银行数据里
                ...
                if gdp_number == '' :
                    ...
                    if gdpinfo[isp_country_code][year] != '' :
                        ...
                        countries_year_gdp[plot_countries_code] = gdp_num    # 把该国家分类为该年有数据并以字典形式保存
                    else :
